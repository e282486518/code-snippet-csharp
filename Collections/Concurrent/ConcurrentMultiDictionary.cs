...
namespace CodeSnippet.Collections.Concurrent
{
    /// <summary>
    /// 三元组合，通过key1,key2查找value
    /// </summary>
    ...
    public class ConcurrentMultiDictionary<TKey1, TKey2, TValue>
    {
        ...
        {
            Ternary<TKey1, TKey2, TValue> ternary = new Ternary<TKey1, TKey2, TValue>(key1, key2, value);
        ...
        {
            if (m_key1ToValue.TryRemove(key, out Ternary<TKey1, TKey2, TValue> ternary))
            {
        ...
        {
            if (m_key2ToValue.TryRemove(key, out Ternary<TKey1, TKey2, TValue> ternary))
            {
        ...
        {
            if (m_key1ToValue.TryGetValue(key, out Ternary<TKey1, TKey2, TValue> ternary))
            {
                value = ternary.Value;
                return true;
            }
        ...
        {
            if (m_key2ToValue.TryGetValue(key, out Ternary<TKey1, TKey2, TValue> ternary))
            {
                value = ternary.Value;
                return true;
            }
